...
function menuRestaurant() {
  ...
  var steak = new OneCard(
    "Steak on butter",
    (0, _foodImages["default"])().steak,
    _text["default"].steak
  );
  var soup = new OneCard(
    "Tomato soup",
    (0, _foodImages["default"])().soup,
    _text["default"].soup
  );
  var chicken = new OneCard(
    "Fresh chicken with salad",
    (0, _foodImages["default"])().chicken,
    _text["default"].chicken
  );
  var pork = new OneCard(
    "Pork with pepper sauce",
    (0, _foodImages["default"])().pork,
    _text["default"].pork
  );
  var rice = new OneCard(
    "Asien special rice",
    (0, _foodImages["default"])().rice,
    _text["default"].rice
  );
  var wine = new OneCard(
    "Red wine",
    (0, _foodImages["default"])().wine,
    _text["default"].wine
  );
  var beer = new OneCard(
    "Traditional beer",
    (0, _foodImages["default"])().beer,
    _text["default"].beer
  );
  centerInfo.append(
    steak.card(),
